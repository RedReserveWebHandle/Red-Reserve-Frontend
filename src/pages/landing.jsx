      ...
      <section className="container mx-auto mt-8 p-6 flex items-center justify-between  shadow-lg">
        <div className="md:w-1/2 md:pr-8 mb-6 md:mb-0">
          ...
          <div className="flex flex-row items-center justify-center flex-wrap gap-x-6">
            <Link to="/hospitalsignup" className="rounded-lg bg-[#1AB6CA] px-6 py-3 font-semibold text-white transition duration-300 hover:bg-teal-500 shadow-md">
              <button>
                Join as Hospital
              </button>
            </Link>
            <div className="mt-4 text-gray-400 text-sm">
              ...
              <p>Want to join the program? Click here!</p>
            </div>
          </div>
        </div>
