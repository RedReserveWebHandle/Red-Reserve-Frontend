      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            {/* New Request Card */}
            <div className="bg-blue-50 rounded-xl p-4 shadow-md flex flex-col items-center justify-center text-center h-full min-h-[120px]">
              <button className="bg-transparent text-teal-600 font-bold py-2 px-4 rounded-xl flex items-center justify-center">
        ...
        <div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex justify-center">
              <button className="bg-blue-100 hover:bg-blue-200 text-blue-700 font-bold py-2 px-6 rounded-full transition duration-300 ease-in-out flex items-center space-x-2">
                <span>Load More</span>
                {/* Down arrow icon */}
                <svg
